...
import Angular from "../assets/angular_icon.png";
...
const Skills = () => {
  return (
    <div
      name="skills"
      className="w-full h-auto pt-20 bg-[#0a192f] text-gray-300"
    >
      {/* Container */}
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        <div>
          ...
          <p className="py-4">
            These are the technologies I'm mostly working with right now.
            However, this is not an exhaustive list because over my last 7 years
            of coding experience from school, work projects, and personal coding
            I have gained plenty of experience in other languages, frameworks,
            and tools aswell.
          </p>
        </div>
