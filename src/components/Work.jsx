...
const Work = () => {
  ...
  return (
    <div
      name="work"
      className="pt-20 pb-40 w-full md:h-screen text-gray-300 bg-[#0a192f]"
    >
      <div className="max-w-[1000px] mx-auto pt-8 p-4 flex flex-col justify-center w-full h-auto">
        <div className="pb-8">
