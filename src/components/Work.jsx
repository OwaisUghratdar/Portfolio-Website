...
const Work = () => {
  ...
  return (
    <div name='work' className='pt-24 w-full md:h-screen text-gray-300 bg-[#0a192f]'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        <div className='pb-8'>
          <p className='text-4xl font-bold inline border-b-4 text-gray-300 border-pink-600'>
            Projects
          </p>
          <p className='py-6'>Here are some of my coding projects. Hover over the images to see the code and try them out yourself!</p>
        </div>
